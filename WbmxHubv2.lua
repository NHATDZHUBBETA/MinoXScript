        ...
        if IsMobile then 
            ...
            ImageLabel.Image = "rbxassetid://6650125399"
        ...
        function Window:NewTab(mmb)
            ...
            function newmm:NewParagraph(cf)
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Wbmx Hub"
        ...
        function SaveSettings2()
            ...
            if not isfolder("Wbmx Hub") then
                makefolder("Wbmx Hub")
            end
            writefile("Wbmx Hub/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
        end
        ...
        function ReadSetting2()
            local s, e =
                ...
                function()
                    ...
                    return HttpService:JSONDecode(readfile("Wbmx Hub/" .. SaveFileName2))
                end
            )
            if s then
                return e
