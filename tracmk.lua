shared.LoaderTitle = "Tnmnaim Hub";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://85703763384134",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=85703763384134";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Description = "Tại Đây",
    Callback = function()
        setclipboard(" https://www.facebook.com/Tnmn1052010");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://85703763384134") then
                    return v729;
                end
            end
        end
